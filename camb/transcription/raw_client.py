...
class RawTranscriptionClient:
    ...
    def get_transcription_result(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[typing.Union[TranscriptionResult, TranscriptExportResult]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.Union[TranscriptionResult, TranscriptExportResult],  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawTranscriptionClient:
    ...
    async def get_transcription_result(
        ...
        *,
        ...
        data_type: typing.Optional[TranscriptDataType] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[typing.Union[TranscriptionResult, TranscriptExportResult]]:
        """
        NOTE: This endpoint should be called only by the users to get values for their runs via API.
        Further we need to validate if the user has access to the run_id, otherwise we should not return the output urls.
